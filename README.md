...
### [第一部分：构建一套适合 React、ES6 开发的脚手架](https://github.com/zhanglongdream/reactRedux/tree/master/lesson-1)
```
...
### [第二部分：Redux 的设计思想](https://github.com/zhanglongdream/reactRedux/tree/master/lesson-2)
```
clone git@github.com:ZengTianShengZ/react-lesson.git
cd lesson-2
npm install
...
### [第三部分：构建 React 项目开发模板](https://github.com/zhanglongdream/reactRedux/tree/master/lesson-3)
```
clone git@github.com:ZengTianShengZ/react-lesson.git
cd lesson-3
npm install
